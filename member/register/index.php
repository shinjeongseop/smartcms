  ...
  <div class="card-body p-4 p-md-5">
    ...
    <form class="d-grid gap-4" method="post" autocomplete="off">
      ...
      <div>
        ...
        <input class="form-control bg-body border-0" id="name" name="name"
      ...
      <div>
        ...
        <input class="form-control bg-body border-0" id="company_name" name="company_name"
      ...
      <div class="d-grid pt-2">
        <?= smartcms_button('회원가입 완료하기', 'submit', 'rounded-pill') ?>
      </div>
    </form>
