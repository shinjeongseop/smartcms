...
<div class="border-bottom bg-body-tertiary px-4 py-3">
  <form id="<?= smartcms_h($board_bulk_form_id) ?>" class="row g-2 align-items-center" method="post" action="<?= smartcms_h(smartcms_board_url((string)$board['board_key'])) ?>" data-board-bulk-form>
    <?= smartcms_csrf_input() ?>
