  ...
  <div class="card-body p-4 p-lg-5">
    <header class="d-flex align-items-start justify-content-between gap-3 mb-4">
      <div>
        <div class="mb-2">
          ...
          <span class="badge bg-primary-subtle text-primary border border-primary-subtle rounded-2 px-3">Gallery</span>
        </div>
      ...
      <section class="mb-5">
        ...
        <div class="list-group list-group-flush rounded-3 overflow-hidden border shadow-sm bg-white">
          <?php foreach ($attachment_files as $index => $file): ?>
            ...
            <a class="list-group-item list-group-item-action bg-white d-flex flex-column gap-1 p-3" href="<?= smartcms_h($download_url) ?>">
    ...
    <footer class="pt-4 border-top">
      <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
        ...
        <a class="btn btn-light border rounded-2 px-4 fw-bold shadow-none text-secondary" href="<?= smartcms_h(smartcms_board_url((string)$board['board_key'])) ?>">목록</a>
      </div>
    </footer>
