...
$youtube = smartcms_board_youtube_link_data($post);
...
<article class="card border shadow-sm bg-white overflow-hidden mb-4">
  <div class="card-body p-4 p-lg-5">
    ...
    <div class="d-flex flex-wrap align-items-center gap-3 py-3 border-top border-bottom text-secondary small mb-4 fw-medium">
