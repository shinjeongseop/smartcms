...
function smartcms_board_move_post_to_board(array $source_board, array $post, array $target_board, array $user): array
{
    ...
    smartcms_board_audit($target_board, ['id' => (int)$post['id']], $user, 'post_move', (string)$source_board['board_name'] . '에서 게시글을 이동했습니다.');
...
function smartcms_board_copy_post_to_board(array $source_board, array $post, array $target_board, array $user): array
{
    ...
    smartcms_board_audit($target_board, ['id' => $target_post_id], $user, 'post_copy', (string)$source_board['board_name'] . '에서 게시글을 복사했습니다.');
