...
function smartcms_admin_mobile_topbar(array $admin, string $title): string
{
    ...
    return '<div class="d-md-none sticky-top bg-body border-bottom px-3 py-2">'
         ...
         . '</a>'
          . '<button class="navbar-toggler border-0 shadow-none p-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#smartcmsAdminNav" aria-controls="smartcmsAdminNav" aria-label="관리자 메뉴 열기">'
          . '<span class="navbar-toggler-icon"></span>'
          . '<span class="visually-hidden">관리자 메뉴 열기</span>'
          . '</button>'
         . '</div>'
